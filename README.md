...
```bash
export ANTHROPIC_BASE_URL="https://mysite.duckdns.org:8443/anthropic"
export ANTHROPIC_API_KEY="从LLM服务提供人获取的API Key"
export CLAUDE_CODE_MODEL="ppio/pa/claude-opus-4-6"
export ANTHROPIC_DEFAULT_OPUS_MODEL="ppio/pa/claude-opus-4-6"
export ANTHROPIC_DEFAULT_SONNET_MODEL="ppio/pa/claude-opus-4-6"
export ANTHROPIC_DEFAULT_HAIKU_MODEL="ppio/pa/claude-opus-4-6"
```
